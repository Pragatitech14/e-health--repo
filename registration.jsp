		...
		<div class="regform">
          ...
          -->
			...
			<div class="boxed" id="FullRegister">
				...
				<form action="RegisterController" name="register" method="post" enctype="multipart/form-data" id="registrationform" >
					<section>
					<table align="center">
						...
						<tr>
							<td colspan="3"><label for="myImage"><b>Upload Your Image </b></label>
