...
<body style="font-size: 30px;">
	...
	<%
		...
		String n="Health ID:   "+    reg.getHealthid()    +"       "+"Name:    "+" "+reg.getRegFname()+"   "+reg.getRegMname()+"  "+reg.getRegLname()+"     "+ "Allergies:   "+mib.getAllergies();
	%>
	<div class="gettingid" id="idid">
		<input type="text" id="idid1" value="<%=n%>"
			style="display: none;">
	<div class="topheader">
		<div class="logo">
	...
	<div class="boxed" id="divToPrint">
		<div class="container">
			<table id="t01"
				...
				<tr>
					<td rowspan="3"><img src="images//<%=reg.getImage()%>" width="230px"
						height="auto"></td>
