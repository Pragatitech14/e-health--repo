...
<body onload="generateQRCode();">
	...
	<div class="gettingid" id="idid">
		<input type="text" id="idid1" value="<%=reg.getCity()%>"
			style="display: none;">
...
<tr>
				<td style="padding: 10px; font-size: 16px; color: rgb(0, 0, 0);"
					bgcolor="#BCFF95" colspan="4"><b>VACCINATION</b>
			...
			<tr style="text-align: center">
				<td style="padding: 10px;" bgcolor="BCFF95"><b>VACCINATION NAME</b></td>
				<td style="padding: 10px;" bgcolor="BCFF95"><b>
						DATE OF ISSUE</b></td>
				<td style="padding: 10px;" bgcolor="BCFF95"><b>ISSUING AUTHORITY</b></td>
			</tr>	
			
			<%for(CertificateBean dhisobjtemp1 : listchis){ %>
			<tr style="text-align: center">
				<td style="padding: 10px;"><%=dhisobjtemp1.getname()%></td>
				<td style="padding: 10px;">Infected on: <%=dhisobjtemp1.getdate()%>
				</td>
				<td style="padding: 10px;"><%=dhisobjtemp1.getauthority()%></td>
			</tr>
			<%} %>
