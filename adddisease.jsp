			...
			<div class="wrapper wrapper--w900">
				<div class="card card-6">
					...
					<div class="card-body" style="color: black;">
						<form action ="AddDiseaseController" method="post" enctype="multipart/form-data">
							<div class="form-row">
							...
							<div class="form-row">
								<div class="name">Disease Description : </div>
								<div class="value">
									<input class="input--style-6" id="hiername" type="text"
										name="hier_name"
										placeholder="Add your disease Description."
							...
							<div class="form-row">
								<div class="name">Diagnostic's Report (Blood, Urine,...etc) :</div>
								<div class="value">
